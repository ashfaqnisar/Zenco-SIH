        ...
        <Card>
            <CardBody>
                <div className="card__title">
                    ...
                    <h5 className="subhead">Use the component <span className="red-text">CarouselSingle</span> with text
                    </h5>
                </div>
                <Carousel>
                    <div>
                        ...
                        <div className="slick-slider__caption">
                            ...
                            <p className="slick-slider__caption-description">Folly words widow one downs few age every
                                seven.</p>
                        </div>
                    </div>
                    <div>
