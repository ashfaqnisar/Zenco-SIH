                    ...
                    >
                        <Card>
                            <CardBody className="landing__testimonial">
                                ...
                                <p className="landing__testimonial-review">We have used many themes on many projects but
                                    none
                                    that have been so easy to work with. The design has delighted our customer and the
                                    code is easy
                    ...
                    >
                        <Card>
                            <CardBody className="landing__testimonial">
                                ...
                                <p className="landing__testimonial-review">The components have been deigned well, which
                                    is
