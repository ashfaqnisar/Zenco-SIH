...
const Technologies = () => (
    <section className="landing__section">
        ...
        <Container>
            <Row>
                <Col md={12}>
                    <h3 className="landing__section-title">The EasyDev based on popular and powerful technological
                        stack.
                ...
                <Col md={6} sm={12} xs={12}>
                    <div className="landing__code-text">
                        <div className="landing__code-wrap">
                            ...
                            <p>We have created a quality product that will be convenient for developers to use. The main
                                advantage
                                is a clean, correct and easy to understand code.
                            </p>
                            <p>React framework allows you to create a component architecture, get the best productivity
                                and
