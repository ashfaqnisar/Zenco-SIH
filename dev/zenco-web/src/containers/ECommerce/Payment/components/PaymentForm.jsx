            ...
            <div className="form__form-group-field">
                <div className="payment__credit-card">
                    <Field
                        ...
                        label={<div><img src={MasterCard} alt="mc"/><p className="payment__credit-name">MasterCard</p>
                        </div>}
                ...
                <div className="payment__credit-card">
                    <Field
                        name="card"
                        component={renderRadioButtonField}
                        label={<div><img src={PayPal} alt="paypal"/><p className="payment__credit-name">PayPal</p>
                        </div>}
