...
import Machine_1 from '../Dashboards/MachinesDashboard/machine1/index';
import Machine_2 from '../Dashboards/MachinesDashboard/machine2/index';
...
import CryptoDashboardEdit from '../Dashboards/2/index';
import ECommerceDashboardEdit from '../Dashboards/1/index';
...
const Usage = () => (
    <Switch>
        ...
        <Route path="/usage/edit/:index" component={CryptoDashboardEdit}/>
    </Switch>
);
...
const Commerce = () => (
    <Switch>
        ...
        <Route path="/solar/edit/:index" component={ECommerceDashboardEdit}/>
    </Switch>
);

const Machine = () => (
    <Switch>
        <Route path={"/machines/1"} component={Machine_1}/>
        <Route path={"/machines/2"} component={Machine_2}/>
    </Switch>
);
